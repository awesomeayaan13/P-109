...
print("Mean, Median, and Mode is Math score is {},{} and {} respectivilly".format(mean,median,mode))
...
listOfDataWithin1StdDev=[result for result in math_score if result > first_std_dev_start and result < first_std_dev_end]
listOfDataWithin2StdDev=[result for result in math_score if result > second_std_dev_start and result < second_std_dev_end]
listOfDataWithin3StdDev=[result for result in math_score if result > third_std_dev_start and result < third_std_dev_end]

print("{}% of data lies within 1 stdev".format(len(listOfDataWithin1StdDev)*100/len(math_score)))
print("{}% of data lies within 2 stdev".format(len(listOfDataWithin2StdDev)*100/len(math_score)))
print("{}% of data lies within 3 stdev".format(len(listOfDataWithin3StdDev)*100/len(math_score)))
