...
mean=statistics.mean(writing_score)
median=statistics.median(writing_score)
mode=statistics.mode(writing_score)
print("Mean,Median And Mode of writing score is {},{} and {} respectivilly".format(mean,median,mode))

std_dev=statistics.stdev(writing_score)
...
listOfDataWithin1StdDev=[result for result in writing_score if result > first_std_dev_start and result < first_std_dev_end]
listOfDataWithin2StdDev=[result for result in writing_score if result > second_std_dev_start and result < second_std_dev_end]
listOfDataWithin3StdDev=[result for result in writing_score if result > third_std_dev_start and result < third_std_dev_end]

print("{}% of data lies within 1 stdev".format(len(listOfDataWithin1StdDev)*100/len(writing_score)))
print("{}% of data lies within 2 stdev".format(len(listOfDataWithin2StdDev)*100/len(writing_score)))
print("{}% of data lies within 3 stdev".format(len(listOfDataWithin3StdDev)*100/len(writing_score)))
